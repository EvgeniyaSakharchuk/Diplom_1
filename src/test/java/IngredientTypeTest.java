...
public class IngredientTypeTest {
    ...
    public void correctTypeIngredientForBurger() {
        if (compositionBurger) {
            Assert.assertNotNull(" Корректный тип ингредиентов для бургеров:", IngredientType.valueOf(typeName));
        } else {
            Assert.assertThrows("Не Корректный тип ингредиентов для бургеров:", IllegalArgumentException.class, () -> IngredientType.valueOf(typeName));
        }
    }
}